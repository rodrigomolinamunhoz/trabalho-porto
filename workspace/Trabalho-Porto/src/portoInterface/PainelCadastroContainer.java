				...
				try {
					if (isNullOrEmpty(textCodigo.getText()) || isNullOrEmpty(textRemetente.getText())
						...
						if (origemRemetente == OrigemRemetente.Caminhao) {
							...
							porto.painelPatio.listarCaminhoes(porto.patio.getCaminhoes());
							porto.painelCadastroCaminhao.listarCaminhoes(porto.patio.getCaminhoes());
						} else {
							porto.patio.getNavios().remove();
							porto.painelPatio.listarNavios(porto.patio.getNavios());
							porto.painelCadastroNavio.listarNavios(porto.patio.getNavios());
						}

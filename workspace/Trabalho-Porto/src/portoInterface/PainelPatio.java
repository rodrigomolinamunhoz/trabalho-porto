...
public class PainelPatio extends JPanel {
	...
	public PainelPatio(PainelPorto porto) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (caminhao == null || container == null) {
					JOptionPane.showMessageDialog(null,
							"Verifique se existe o container ou caminhão selecionado no pátio!", "Erro",
					...
					JOptionPane.showMessageDialog(null, "Container carregado com sucesso!", "Informação",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(null, "Código do Container com Placa não conferem!", "Erro",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		tableNavios.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Matrícula", "Transportadora" }) {
		...
		bnCarregaNavio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (navio == null || container == null) {
					JOptionPane.showMessageDialog(null,
							"Verifique se existe o container ou navio selecionado no pátio!", "Erro",
							JOptionPane.ERROR_MESSAGE);
		...
		tableContainers.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Código", "Remetente", "Destinatário", "Conteúdo", "Data de Entrada" }) {
			public boolean isCellEditable(int rowIndex, int mColIndex) {
				return false;
			}
		});

...
public class PainelCadastroNavio extends JPanel {
	...
	public PainelCadastroNavio(Patio patio) {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					if (isNullOrEmpty(textTransportadora.getText()) || isNullOrEmpty(textMatricula.getText())) {
						JOptionPane.showMessageDialog(null, "Matrícula ou Transportadora não foram informados!",
		...
		table = new JTable();
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Matrícula", "Nome Transportadora" }) {
